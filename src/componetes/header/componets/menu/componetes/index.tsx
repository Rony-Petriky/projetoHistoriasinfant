...
export function MenuMobileouPc(){
    ...
    return (<>
        ...
        >
          ...
          <nav className={drawerClasses}>
              ...
              <li className="pb-3" ><button className="font-medium text-white text-lg flex flex-row items-center" onClick={()=>handleLogout()} >SAIR</button></li>
              </ul>
          </nav>
        ...
        <ul className="list-none flex space-x-6 m-0 p-0">
            ...
            <li className="text-white font-bold hover:text-blue-200 text-lg" onClick={()=>handleLogout()}>SAIR</li>
